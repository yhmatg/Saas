...
public class InventoryOrderPage {
    ...
    private int total;
    private List<ResultInventoryOrder> list;
    ...
    public List<ResultInventoryOrder> getList() {
        return list;
    }

    public void setList(List<ResultInventoryOrder> list) {
        this.list = list;
    }
