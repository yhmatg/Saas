package com.common.esimrfid.xfxj;
...
import com.common.esimrfid.ui.home.SettingActivity;
import com.common.esimrfid.ui.identity.IdentityActivity;
import com.common.esimrfid.utils.SettingBeepUtil;
import com.common.esimrfid.utils.ToastUtils;
import com.common.esimrfid.xfxj.assetinventory.XfAssetInventoryActivity;
...
public class XfHomeActivity extends BaseActivity<HomePresenter> implements HomeConstract.View {
    ...
    private void initDatabaseData() {
        ...
        XfResultInventoryOrder xfResultInventoryOrderOne = new XfResultInventoryOrder("invId001", "invCode001", "巡检任务1", "巡检人1", "9月10日", "15:00", 1, 3, 0);
        XfResultInventoryOrder xfResultInventoryOrderTwo = new XfResultInventoryOrder("invId002", "invCode002", "巡检任务2", "巡检人2", "9月11日", "15:00", 1, 3, 1);
        XfResultInventoryOrder xfResultInventoryOrderThree = new XfResultInventoryOrder("invId003", "invCode003", "巡检任务3", "巡检人3", "9月11日", "15:00", 1, 3, 2);
        ...
        XfInventoryDetail xfInventoryDetailOne = new XfInventoryDetail("detail001", "invId001", "ast001","detail001","detail001", "品牌1", "100000000001", "一楼", "公司1", "张三","9月12日","正常","w0001","张三","9月10日","说明1",0,0, 0, 0, 0, 0, 0,"");
        XfInventoryDetail xfInventoryDetailTwo = new XfInventoryDetail("detail002", "invId001", "ast002","detail002","detail002", "品牌1", "100000000002", "二楼", "公司1", "张三","9月12日","正常","w0001","张三","9月10日","说明1",0, 0, 0, 0, 0, 0,0,"");
        XfInventoryDetail xfInventoryDetailThree = new XfInventoryDetail("detail003", "invId001", "ast003","detail003","detail003", "品牌1", "100000000003", "三楼", "公司1", "张三","9月12日","正常","w0001","张三","9月10日","说明1",0, 0, 0, 0, 0, 0,0,"");
        XfInventoryDetail xfInventoryDetailFour = new XfInventoryDetail("detail004", "invId002", "ast004","detail004","detail004", "品牌1", "100000000004", "三楼", "公司1", "张三","9月12日","正常","w0001","张三","9月10日","说明1",0, 0, 0, 0, 0, 0,0,"");
        XfInventoryDetail xfInventoryDetailFive = new XfInventoryDetail("detail005", "invId002", "ast005","detail005","detail005", "品牌1", "100000000005", "三楼", "公司1", "张三","9月12日","正常","w0001","张三","9月10日","说明1",0, 0, 0, 0, 0, 0,0,"");
        XfInventoryDetail xfInventoryDetailSix = new XfInventoryDetail("detail006", "invId002", "ast006","detail006","detail006", "品牌1", "100000000006", "三楼", "公司1", "张三","9月12日","正常","w0001","张三","9月10日","说明1",0, 0, 0, 0, 0, 0,0,"");
