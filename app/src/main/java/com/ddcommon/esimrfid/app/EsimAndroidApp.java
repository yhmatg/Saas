package com.ddcommon.esimrfid.app;
...
import com.ddcommon.esimrfid.BuildConfig;
...
import com.ddcommon.esimrfid.uhf.NewSpeedataUhfServiceImpl;
import com.ddcommon.esimrfid.uhf.RodinbellUhfServiceImpl;
import com.ddcommon.esimrfid.uhf.ZebraUhfServiceImpl;
import com.ddcommon.esimrfid.utils.Utils;
import com.ddcommon.esimrfid.utils.logger.MyCrashListener;
import com.ddcommon.esimrfid.utils.logger.TxtFormatStrategy;
...
public class EsimAndroidApp extends Application {
    ...
    public void onCreate() {
        ...
        Utils.init(this);
        //崩溃日志保存到本地
        ///storage/emulated/0/Android/data/com.ddcommon.esimrfid/cache/crash_log
        XLog.init(this);
