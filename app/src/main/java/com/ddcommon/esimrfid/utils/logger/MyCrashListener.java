package com.ddcommon.esimrfid.utils.logger;
...
public class MyCrashListener implements OnCrashListener {
    ...
    public void onCrash(Context context, ICrashHandler crashHandler, Throwable throwable) {
        ...
        Toast.makeText(context, "程序异常日志路径：/storage/emulated/0/Android/data/com.ddcommon.esimrfid/cache/crash_log", Toast.LENGTH_LONG).show();
