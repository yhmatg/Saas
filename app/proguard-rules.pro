...
-dontwarn com.hitown.hitownsdk.HitownAC3508Control

-keep class com.hitown.hitownsdk.HitownAC3508Control { *; }

-dontwarn com.rscja.deviceapi.**

-keep class com.rscja.deviceapi.** { *; }

-dontwarn cn.trinea.android.common.util.**

-keep class cn.trinea.android.common.util.** { *; }

-dontwarn com.odm.tools.Tools
